 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_ob_jnicallback_MainActivity_nativeInitilize(JNIEnv *env, jobject thiz) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_ob_jnicallback_MainActivity_nativeThreadStart(JNIEnv *env, jobject thiz) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_ob_jnicallback_MainActivity_NativeThreadStop(JNIEnv *env, jobject thiz) {
    gIsThreadExit = 1;
